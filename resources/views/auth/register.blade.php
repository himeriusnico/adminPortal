...
@section('content')
    <div class="auth-container">
        <div class="auth-wrapper register-page">
            ...
            <div class="auth-card">@extends('layouts.app')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('position') is-invalid @enderror" id="position"
                                            ...
                                            <option value="Staf Akademik"
                                                {{ old('position') == 'Staf Akademik' ? 'selected' : '' }}>Staf Akademik
                                            </option>
                                            <option value="Dekan" {{ old('position') == 'Dekan' ? 'selected' : '' }}>Dekan
                                            </option>
                                            <option value="Kepala Prodi"
                                                {{ old('position') == 'Kepala Prodi' ? 'selected' : '' }}>Kepala Prodi
                                            </option>
                                        </select>
                                        @error('position')
                                            <div class="invalid-feedback">{{ $message }}</div>
